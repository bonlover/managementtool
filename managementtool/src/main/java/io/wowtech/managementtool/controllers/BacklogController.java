...
import io.wowtech.managementtool.services.ProjectTaskService;
...
public class BacklogController {
    ...
    public  ResponseEntity<?> deleteProjectTask(@PathVariable String backlog_id, @PathVariable String pt_id){
        ...
        return  new ResponseEntity<String>("Project Task '"+backlog_id+"' with sequence '"+pt_id+"' was deleted successfiully.", HttpStatus.OK);
    }
